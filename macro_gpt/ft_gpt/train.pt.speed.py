...
gpt2_config = LLMConfig.from_json_file(PATH_MODEL_CONFIG)
model = LLMForCausalLM(gpt2_config)
model.init_weights()
model.gradient_checkpointing_enable()
model.enable_input_require_grads()
...
"""
nohup deepspeed --num_gpus=2 train.pt.speed.py --deepspeed ds.json  > tc.train.pt.speed.py.log 2>&1 &
"""
